...
const ModalContent = React.forwardRef(({ className, children, ...props }, ref) => (
    <ModalPortal>
        ...
        <DialogPrimitive.Content
            ref={ref}
            className={cn(
                "fixed left-[50%] top-[50%] z-[9999] w-full max-w-lg min-h-[300px] min-h-[300px] max-h-[90vh] translate-x-[-50%] gap-4 border bg-background p-6 shadow-lg sm:rounded-lg overflow-auto",
                className
            )}
            {...props}
        >
